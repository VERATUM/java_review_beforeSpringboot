 ...
 */
@WebServlet("/testTrain/TrainInfoServlet2")
public class TrainInfoServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Class<?> aClass = Class.forName("com.trainSys.servlet.TrainInfoServlet2");
