 ...
 *
 */
@WebListener("/testServlet/index.jsp")
public class TestListener implements ServletRequestListener, ServletRequestAttributeListener, AsyncListener {
    ...
    public void attributeRemoved(ServletRequestAttributeEvent arg0)  { 
    	...
    	System.out.println("attr删除:属性:"+name+"值:"+object);
    }
